...
public class PArrayUtils {
    ...
    /**
     * Return the start and end index of fixed-number subsets of an array,
     * bound[i][1] is exclusive
     *
     * @param arraySize
     * @param subsetNumber
     * @return
    ...
    /**
     * Return the start and end index of fixed-size subsets of an array,
     * bound[i][1] is exclusive
     *
     * @param arraySize
     * @param subsetSize
     ...
     * Good when maxValue is large Designed to generate subset indices
     *
     * @param maxValue
     * @param size
     * @return
    ...
    /**
     * Generate a random integer array, plus value Good when maxValue is small
    ...
    /**
     * Shuffle an int array Implementing Fisher–Yates shuffle
     *
     * @param ar
     */
    ...
    /**
     * Shuffle an double array Implementing Fisher–Yates shuffle
     *
     * @param ar
     */
